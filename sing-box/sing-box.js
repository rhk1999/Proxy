  ...
  if (["其它"].includes(i.tag)) {
    i.outbounds.push(
      ...proxies
        .filter(
          (p) =>
            !/🇨🇳|镇江|徐州|武汉|济南|香港|direct|HongKong|Hong Kong|HK|台湾|Taiwan|TW|日本|东京|Japan|JP|新加坡|Singapore|SG|美国|America|United States|US|韩国|Korea|KR/i.test(
              p.tag,
            ),
        )
        .map((p) => p.tag),
