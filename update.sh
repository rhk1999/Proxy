...
INSTALL_DIR="$HOME/Sub-Store"  # 安装目录，可以根据需要修改
...
echo "http-meta started in background, logs at: $DATA_DIR/http-meta.log"
...
echo "Sub-Store started in background, logs at: Sub-Store.log"
